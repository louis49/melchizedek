...
- `m9k_info` now includes the plugin version in its output
- Split README into focused documentation: `docs/installation.md`, `docs/enhanced-search.md`, `docs/configuration.md`

### Fixed

- Version read from `package.json` instead of hardcoded constant
- Build script cleans `dist/` before compiling to prevent stale files from deleted sources
